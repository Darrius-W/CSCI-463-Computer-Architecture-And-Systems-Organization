...
/**
 * Member function to_hex0x20 is responsible for returning "0x" concatenated
 * with the 5 hex digits representing the 20 least significant bits of i.
 *
 * @param i is an unsigned 32bit integer.
 *
 * @return returns a string representing 5 hex digits concatenated with "0x".
********************************************************************************/
...
/**
 * Member function to_hex0x12 is responsible for returning "0x" concatenated
 * with the 3 hex digits representing the 12 least significant bits of i.
 *
 * @param i is an unsigned 32bit integer.
 *
 * @return returns a string representing 3 hex digits concatenated with "0x".
********************************************************************************/
